...
![Vista de tabla de la aplicación](./screenshots/table-view.png)

### Vista de Detalle de la Obra
![Página de detalle de una obra](./screenshots/detail-view.png)
...
- **Exportar a Hojas de Cálculo**: Funcionalidad para exportar datos del inventario.
...
[Agrega instrucciones para contribuir si planeas hacer el proyecto open source]

---

**Nota**: Este proyecto está diseñado específicamente para gestionar inventarios de obras de arte y facilitar su integración con plataformas de e-commerce.
